// Generated from /home/gutierrez/projetjava/miniJava/MiniJava/src/fr.n7.stl.minic/MiniCParser.g4 by ANTLR 4.13.1
...
public class MiniCParser extends Parser {
	...
	public final BlocContext bloc() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2269119281848336L) != 0)) {
				{
				{
				setState(30);
	...
	public final InstructionContext instruction() throws RecognitionException {
		...
		try {
			...
			case 8:
				...
				match(ParentheseFermante);
				setState(101);
				((InstructionTantQueContext)_localctx).do_ = bloc();
				}
				break;
			case 9:
